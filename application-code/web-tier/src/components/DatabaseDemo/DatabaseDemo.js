  ...
  render() {
    return (
      <div>
        ...
        <input style={{ float: "right", marginBottom: "1em" }} type="button" value="DEL" onClick={this.handleButtonClickDel} />
        <table id='transactions'>
          <tbody>
            ...
            <tr>
              ...
              <td><input type="text" name="text_amt" value={this.state.text_amt} onChange={this.handleTextChange.bind(this)} /></td>
              <td><input type="text" name="text_desc" value={this.state.text_desc} onChange={this.handleTextChange.bind(this)} /></td>
            </tr>
